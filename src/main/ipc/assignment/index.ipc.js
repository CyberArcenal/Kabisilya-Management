...
class AssignmentHandler {
  ...
  initializeHandlers() {
    ...
    this.getWorkerPerformanceReport = this.importHandler(
      "./get/worker_performance.ipc",
    );
    ...
    this.bulkUpdateAssignments = this.importHandler(
      "./bulk/bulk_update.ipc.js",
    );
    ...
    this.syncAssignmentsFromExternal = this.importHandler(
      "./sync_external.ipc.js",
    );

    // ⚙️ VALIDATION HANDLERS
    this.validateAssignmentData = this.importHandler(
      "./validation/validate_data.ipc.js",
    );
    this.checkWorkerAvailability = this.importHandler(
      "./check_worker_availability.ipc.js",
    );
    this.validateLuWangCount = this.importHandler(
      "./validation/validate_luwang_count.ipc.js",
    );
  }
    ...
    try {
      ...
      switch (method) {
        ...
        case "getActiveAssignments":
          // @ts-ignore
          return await this.getActiveAssignments(
            // @ts-ignore
            enrichedParams.filters,
            userId,
          );
        ...
        case "getCompletedAssignments":
          // @ts-ignore
          return await this.getCompletedAssignments(
            // @ts-ignore
            enrichedParams.filters,
            userId,
          );
        ...
        case "getCancelledAssignments":
          // @ts-ignore
          return await this.getCancelledAssignments(
            // @ts-ignore
            enrichedParams.filters,
            userId,
          );
        ...
        case "getAssignmentStats":
          // @ts-ignore
          return await this.getAssignmentStats(
            // @ts-ignore
