...
module.exports = async function updateWorkerStatus(
  params = {},
  queryRunner = null,
) {
  ...
  try {
    ...
    // ✅ CORRECTED: Use repository.save() instead of queryRunner.manager.save()
    const updatedWorker = await workerRepository.save(existingWorker);
