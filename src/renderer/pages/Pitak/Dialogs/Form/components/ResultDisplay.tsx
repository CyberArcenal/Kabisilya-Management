...
import { TraditionalMeasurement, type CalculationResult } from '../utils/measurement';
...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({
  ...
  // Format conversion ratios for display
  const getConversionExplanation = () => {
    const explanations = TraditionalMeasurement.getConversionExplanation(layoutType as any, buholInputs);
    return explanations.slice(3); // Skip the first 3 general explanations
  };
    ...
    <div className="space-y-4">
      ...
      <div className="p-3 bg-blue-50 rounded border border-blue-200">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="text-xs font-medium text-blue-800">Traditional Measurement System</div>
        </div>
        ...
        <div className="text-xs text-blue-700 space-y-1">
          ...
          <div className="text-xs text-gray-600">
            Method: <span className="font-medium text-blue-800">{measurementMethod}</span>
          </div>
        </div>
      </div>

      {/* Results Grid - 2 columns only (no hectare) */}
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className="text-xs font-medium text-yellow-800">Total LuWang</div>
          </div>
          <div className="text-center">
      ...
      {buholInputs && Object.keys(buholInputs).length > 0 && (
        <div className="p-3 bg-gray-50 rounded border border-gray-200">
          <div className="text-xs">
            <div className="font-medium text-gray-800 mb-2">Traditional to Modern Conversion:</div>
      ...
      <div className="p-3 bg-gradient-to-r from-green-50 to-blue-50 rounded border border-green-200">
        ...
        <div className="text-xs text-gray-700 space-y-1">
          <div>This plot has an area of {results.areaSqm.toFixed(2)} square meters,</div>
          <div>which is equivalent to {results.totalLuwang.toFixed(2)} luwang.</div>
