...
import {
    Save, RefreshCw, Download, Upload, AlertCircle, Settings,
...
const FarmManagementSettingsPage: React.FC = () => {
    ...
    useEffect(() => {
        if (saveSuccess) {
            setToast({ message: 'Farm settings saved successfully!', type: 'success' });
            setTimeout(() => setToast(null), 3000);
        }
        if (saveError) {
            setToast({ message: `Failed to save settings: ${saveError}`, type: 'error' });
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center max-w-md">
                    ...
                    <h2 className="text-2xl font-bold mb-2 text-gray-800">Failed to Load Settings</h2>
            ...
            <div className="mb-6 p-4 bg-white border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm">
                        <span className={`font-medium ${hasChanges ? 'text-green-600' : 'text-gray-400'}`}>
