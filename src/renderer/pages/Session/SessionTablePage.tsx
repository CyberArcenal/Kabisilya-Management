                        ...
                        <table className="w-full">
                            <thead>
                                <tr style={{ background: 'var(--table-header-bg)' }}>
                                    ...
                                    {['Name', 'Year', 'Season Type', 'Start Date', 'End Date', 'Status', 'Actions'].map((header) => (
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                Manage farming seasons, assign bukids, and track worker assignments
                            </p>
                        </div>
                        ...
                        {!loading && sessions.length === 0 ? (
                            <div className="flex items-center justify-center h-64 rounded-xl border-2 border-dashed border-gray-300 bg-white">
                                <div className="text-center p-8">
                                    <Calendar className="w-16 h-16 mx-auto mb-4 opacity-20" style={{ color: 'var(--text-secondary)' }} />
                                    <h3 className="text-lg font-semibold mb-2 text-gray-800">
                                        No Sessions Found
                                    </h3>
                                    <p className="text-sm mb-6 max-w-md mx-auto text-gray-600">
                                        {searchQuery || statusFilter !== 'all' || yearFilter !== 'all' || seasonTypeFilter !== 'all'
