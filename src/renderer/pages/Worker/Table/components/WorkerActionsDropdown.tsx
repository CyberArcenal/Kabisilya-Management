...
import {
    Eye, Edit, Trash2, UserPlus, UserMinus, Printer, DollarSign,
    FileText, History, MoreVertical, CreditCard, Mail, Phone,
    MapPin, Calendar, Download, Clock, XCircle, CheckCircle, Users,
    FileDigit, Building, ArrowUpDown, Activity, Shield, Globe
} from 'lucide-react';
...
const WorkerActionsDropdown: React.FC<WorkerActionsDropdownProps> = ({
    ...
    const getStatusIcon = (status: string) => {
        switch (status) {
            ...
            case 'inactive': return UserMinus;
                        ...
                        <div className="px-4 py-3 border-b border-gray-100">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 truncate">ID: {worker.id}</p>
                                </div>
                            </div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <StatusIcon className={`w-4 h-4 ${getStatusColor(worker.status)}`} />
                            ...
                            <div className="space-y-2">
                                {worker.contact && (
                                    <div className="flex items-center gap-2 text-sm">
                                        ...
                                        <span className="text-gray-700 truncate">{worker.contact}</span>
                                    </div>
                                )}
                                {worker.email && (
                                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <div className="px-4 py-2">
                            ...
                            <div className="space-y-1">
                                <button
                                    ...
                                    className="flex items-center gap-3 w-full px-2 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-3 w-full px-2 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded"
                                >
                                    <CreditCard className="w-4 h-4" style={{ color: 'var(--accent-green)' }} />
                            ...
                            <div className="grid grid-cols-2 gap-1">
                                {worker.status !== 'active' && (
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-2 py-2 text-xs text-gray-700 hover:bg-green-50 hover:text-green-700 rounded"
                                    >
                                ...
                                {worker.status !== 'inactive' && (
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-2 py-2 text-xs text-gray-700 hover:bg-gray-50 rounded"
                                    >
                                ...
                                {worker.status !== 'on-leave' && (
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-2 py-2 text-xs text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 rounded"
                                    >
                                ...
                                {worker.status !== 'terminated' && (
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-2 py-2 text-xs text-gray-700 hover:bg-red-50 hover:text-red-700 rounded"
                                    >
