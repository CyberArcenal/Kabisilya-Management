// components/Kabisilya/components/KabisilyaPagination.tsx
import React from 'react';
import { ChevronLeft, ChevronRight } from 'lucide-react';

interface KabisilyaPaginationProps {
    currentPage: number;
    totalPages: number;
    totalItems: number;
    limit: number;
...
const KabisilyaPagination: React.FC<KabisilyaPaginationProps> = ({
    currentPage,
    totalPages,
    totalItems,
    limit,
...
export default KabisilyaPagination;